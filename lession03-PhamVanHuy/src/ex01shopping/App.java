...
public class App {
	public static void main(String[] args) {
		...
		Order o2 = new Order(c2, new ItemDetail[] {
				new ItemDetail(i3,2),
				new ItemDetail(i5,1)
				},LocalDateTime.of(2025, 5, 7, 20, 10, 12));
		...
		System.out.println("Order 1: " + OrderIUtils.export(o1));
		System.out.println("Order 2: " + OrderIUtils.export(o2));
		System.out.println("Order 3: " + OrderIUtils.export(o3));
		/*
