...
public class App {
	...
	public static void main(String[] args) {
		...
		Item i5 = new Item("WP8", "WindownPhone" ,"Blue" , 560);
		 ...
		 Order o1 = new Order(c1 , new ItemDetail[] { new ItemDetail(i1,3),new ItemDetail(i4,5),new ItemDetail(i2,1)},LocalDateTime.of(2021, 5, 8, 10, 10, 10));
		 Order o2 = new Order(c2 , new ItemDetail[] { new ItemDetail(i3,2),new ItemDetail(i5,1)},LocalDateTime.of(2021, 5, 7, 20, 10, 12));
...
//		 System.out.println("Order3 : "+ o3.export());
		...
		/*
	 	...
	 	i2: SS20+, Android, Green, 80
	 	i3: IP4, IOS, White, 280
	 	i4: IP12, IOS, Black, 880
	 	i5: WP8, WindownPhone , Blue , 560
		o1: c1, {id1(i1,3), id2(i4,1), id3(i2,1)},10:10:10 8.5.2021
		o2: c2, {id1(i3,2), id2(i5,1)},20:10:12 7.5.2021
		o3: c2, {id1(i4,1)},09:28:32 8.5.2021
	 */
