 ...
 */
	public static void main(String[] args) {
		System.out.println("=== Khởi tạo đối tượng thông thường");
		Shape shape1 = new Shape();
		Square square1 = new Square();
		Rectangle rectangle1 = new Rectangle();
		
		shape1.calcS(); //Shape#calS... unknown
		square1.calcS(); //Square#calcS...formula
		rectangle1.calcS(); //Rectangle#calscS...formula
...
//		s2 = s1;
	...
	/* Giải thích: đa hình trong đối tượng
	   ...
	   1. Tại sao không lấy biến KDl đối tượng khởi tạo cho chính KDL class của nó mà phải lấy biến cha trỏ đến đối tượng con?
	   ...
	   2. Đa hình trong đối tượng, biến KDL cha có thể trỏ/ gán đến KDL con
