...
public class InheritanceInterfaceDemo {
	public static void main(String[] args) {
		...
		// sử dụng khi interface chỉ có 1 cái hàm trừu tượng và phần thực thi bên trog hàm trừu tượng ngắn
		Shape sh1 =new Shape() {
		@Override
		public void calcS() {
		...
		// sử dụng khi interface chỉ có 1 cái hàm trừu tượng và phần thực thi bên trog hàm trừu tượng dài
