...
public class Ex04StringOperations {
	...
	public static void main(String[] args) {
		...
		//1. Kiểm tra chuỗi s1 có phải là chuỗi bắt đầu || kết thúc trong chuỗi s k
		System.out.println("1. Kiểm tra chuỗi bắt đầu, kết thúc: " + s.endsWith("Java"));
		
		//2. Thay thế chuỗi s1 = chuỗi s2 trong  chuỗi s
		...
		//5. Xđ chuỗi s2 có tồn tại trong chuỗi s1 hay k
