...
public class Ex07TransactionDemo {
	...
	public static void main(String[] args) {
		...
		List<Transaction> transactions = DataModel.mockTransaction();
		
		generate("0. Original Data", transactions);
		
		generate("1. Find all transactions in the year 2026 and sort them by value (small to high)", 
				transactions.stream()
					.filter(t -> t.getDate().get(ChronoField.YEAR) == 2026)
