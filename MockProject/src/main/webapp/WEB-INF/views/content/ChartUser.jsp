	...
	<div class="content">
		...
		<div class="mt-4">
			<div class="search w-10 px-3 d-flex justify-content-between">
				<form class="w-25"
					action="${pageContext.request.contextPath}/ChartUser"
					method="POST">
				...
				<a
					href="
					${pageContext.request.contextPath}/DownloadFileUser?yearex=${year}">
			...
			<c:if test="${not empty userData}">
				...
				function drawChart() {
					var data = google.visualization.arrayToDataTable([
						['Tháng', 'Tài khoản hoạt động','Tài khoản bị khoá','Tổng tài khoản'],
						<c:forEach items="${userData}" var="item" varStatus="loop">
					    ['Tháng ${item[0]}', ${item[1] != null ? item[1] : 0}, ${item[2] != null ? item[2] : 0}, ${item[3] != null ? item[3] : 0}] 
					    <c:if test="${!loop.last}">,</c:if>
					</c:forEach>
					]);
					var options = {
					title: 'Số lượng tài khoản theo tháng - ${year}',
