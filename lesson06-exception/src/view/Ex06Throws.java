...
public class Ex06Throws {
	...
	//compile (check) exception: là những exception bắt buộc mình phải xử lý tại thời điểm compile
	
	//runtime(inchecked) exception: là những exception không bắt buộc phải xử lý tại thời điểm compile
	...
	//khi throw 1 compile exception, tại vị trí khai báo hàm phải throws để chỗ gọi hàm biết và bắt buộc phải xử lý complie exception đó
