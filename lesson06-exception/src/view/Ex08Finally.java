...
public class Ex08Finally {
	...
	public static void main(String[] args) {
		...
		gennerate("Danh sách nhân viên --> ", storage);
		...
		try {
			//connect file
			 ...
			 for (Employee employee: employees) {
				 ...
				 String line;
				 if(age < 18 || age > 60) {
					 line = "dữ liệu của NV" + employee.getId() + "khong hợp lệ";
				 } else {
			 ...
			 //th1: nếu dòng thứ k bị lỗi --> ghi dữ liệu từ 1 - (k_1), sau đó ko ghi
	...
	private static void gennerate(String statement, Employee[] employees) {
