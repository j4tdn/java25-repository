...
public class Ex04BasicOperations {
	public static void main(String[] args) {
		...
		//Giao 2 danh sách
		List<String> interset = new ArrayList<>(list1);
		interset.retainAll(list2);
		generateStrings("2. Kết quả sau khi giao 2 danh sách", interset);
		
		//Hiệu 2 danh sách
		List<String> diff = new ArrayList<>(list1);
		diff.removeAll(list2);
		generateStrings("3. Kết quả sau khi hiệu 2 danh sách", diff);
