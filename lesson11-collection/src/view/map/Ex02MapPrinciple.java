...
public class Ex02MapPrinciple {
	 ...
	 *  V: List<String>
	 *  
	 * - Cơ chế phát hiện key đã tồn tại bên trong map chưa
	 * 
	 * - Khi put một phần tử mới vào trong map, map kiểm tra:
	 * - key đã tồn tại bên trong map hay chưa thông qua so sánh
	 *   - hashing value: hashcode (mặc định là địa chỉ mà JVM cấp phát cho đối tượng)
	 *   - value        : equals   (mặc định dùng Objects#equals so sánh đại chỉ của đối tượng)
	 *   
	...
	public static void main(String[] args) {
		...
		generate("1. Danh sách các mặt hàng và cửa hàng liên quan", items);
	}
