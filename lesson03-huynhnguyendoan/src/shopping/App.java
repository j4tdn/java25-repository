...
public static void main(String[] args) {
	...
	Order o1 = new Order(c1, new ItemDetail[] {
		new ItemDetail(i1,3),new ItemDetail(i4,5), new ItemDetail(i2,1)
	}, LocalDateTime.of(2021,5,8,10,10,10));
	
	Order o2 = new Order(c2, new ItemDetail[] {
			new ItemDetail(i3,2),new ItemDetail(i5,1)
	...
	System.out.println("Order 1: "+ OrderUtil.export(o1));
	System.out.println("Order 2: "+ OrderUtil.export(o2));
	System.out.println("Order 3: "+ OrderUtil.export(o3));
