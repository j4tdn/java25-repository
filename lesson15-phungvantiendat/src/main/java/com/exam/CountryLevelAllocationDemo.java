...
import static com.exam.model.DataModel.*;

import com.exam.calculation.calculator.CountryLevelCalculator;
...
public class CountryLevelAllocationDemo {
	...
	private static CountryLevelContext buildCountryLevelContext() {
		return CountryLevelContext.of()
                ...
                .withReferenceStores(mockRefStores())
                .withReferenceItemStores(mockRefItemStores())
