...
public class Ex02Explain {
	...
	public static void main(String[] args) {
		 ...
		 *  - Gán value trực tiếp cho biến(Java sẽ xử lý việc tạo đối tượng lưu vào)
		 *  
		 *  Giống nhau:
		 *  - KDL đối tượng, đều lưu trữ ở HEAP
		 *  - KDL String có biến value là private final --> giá trị của ô nhớ HEAP là hằng số(k thay đổi)
		 *  
		 *  Khác nhau:
		 *  - Dùng toán tử new khởi tọa đối tượng:
		 *  	+ Lưu trữ tại ô nhớ bình thường tại vùng nhớ HEAP
		 *  	+ Khi khởi tạo với new --> luôn tạo ô nhớ mới tại HEAP
		 *  
		 *  - Gán giá trị trực tiếp cho biến
		 *   	+ Lưu trữ tại HEAP - CONSTANT POOL (vùng lưu trữ các ô nhớ có các giá trị ko trùng khớp)
		 *  	+ Khi khởi tạo giá trị --> kiểm tra xem giá trị mới đó đã xuất hiện trong constant pool chưa
		 *  		* Nếu giá trị đó đã chưa trong 1 ô nhớ ở CONSTANT POOL -> ko khởi tạo ô nhớ mới, dùng ô nhớ cũ 
		 ...
		 */
			//  - Dùng toán tử new khởi tạo đối tượng
				...
				System.out.printf("o1 [value=%s]  [hashcode%s]\n ",o1,System.identityHashCode(o1));
				System.out.printf("o2 [value=%s]  [hashcode%s]\n ",o2,System.identityHashCode(o2));
				System.out.printf("o3 [value=%s]  [hashcode%s]\n ",o3,System.identityHashCode(o3));
				...
				System.out.printf("s2 [value=%s]  [hashcode%s]\n ",s2,System.identityHashCode(s2));
				System.out.printf("s3 [value=%s]  [hashcode%s]\n ",s3,System.identityHashCode(s3));
				System.out.println("\n");
