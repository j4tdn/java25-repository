...
public class App {
	public static void main(String[] args) {
		/*
			...
			o1: c1, {id1(i1, 3), id2(i4, 1), id3(i2, 1)}, 10:10:10 08.05.20221
		...
		Oder o1 = new Oder(c1, new ItemDetail[] {
				   new ItemDetail(i1, 3),
			   	   new ItemDetail(i4, 5),
				   new ItemDetail(i2, 1)
		}, LocalDateTime.of(2021, 5, 8, 10, 10, 10));
		
		Oder o2 = new Oder(c2, new ItemDetail[] {
				   new ItemDetail(i3, 2),
				   new ItemDetail(i5, 1)
		}, LocalDateTime.of(2021, 5, 7, 20, 10, 12));
		
		Oder o3 = new Oder(c2, new ItemDetail[] {
				   new ItemDetail(i4, 1)
		}, LocalDateTime.of(2021, 5, 8, 9, 28, 32));
		
		System.out.println("Order 1: "+ OderUntils.export(o1));
		System.out.println("Order 2: "+ OderUntils.export(o2));
		System.out.println("Order 3: "+ OderUntils.export(o3));
