...
public class Ex03Assignments {
	...
	public static void main(String[] args) {
		/*
		 Để cập nhật giá trị cho biến là
		 
		 - KDL Nguyên Thủy
		   TT  Giá trị lưu ở STACK
		   --> Thông qua toán tử gán '=' --> Copy cập nhật giá trị tại vùng nhớ STACK
		   
		 - KDL Đối Tượng
		   TT Giá trị thật sự của đối tượng lưu ở HEAP
		   TT Giá trị của biến ở vùng nhớ STACK là địa chỉ của ô nhớ HEAP mà nó đang trỏ đến
		 ...
		 Toán tử gán '=' 100% hoạt động ở STACK
