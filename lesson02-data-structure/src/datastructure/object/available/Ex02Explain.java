...
public class Ex02Explain {
	...
	public static void main(String[] args) {
		/*
			...
			Khi khao báo biến KDL có sẵn như là Integer, Double, String, ...
			Có 2 cách
			- Dùng toán tử new khởi tạo đối tượng
			- Gán giá trị trực tiếp cho biến(JAVA sẽ tự tạo đối tượng lưu vào)
			
			Giống nhau
			- KDL đối tượng, lưu trữ ở vùng nhớ HEAP
			- KDL String, biến value là private final --> giá trị ô nhớ tại HEAP là hằng số
			
			Khác nhau
			- Dùng toán tử new khởi tạo đối tượng
				* Lưu trữ tại 1 ô nhớ bình thường trong HEAP
			...
			- Gán giá trị trực tiếp cho biến
				...
				* Khi khởi tạo giá trị --> kiểm tra xem giá trị mới đó đã xuất hiện trong constant pool chưa
					+ Nếu giá trị đó đã chứa trong 1 ô nhớ ở CONSTANT POOL => ko khởi tạo ô nhớ mới, dùng ô nhớ cũ trong CONSTANT POOL
					+ Chưa tồn tại --> Tạo ô nhớ mới và gán giá trị
		...
		System.out.printf("s3 [value=%s] [hash=%s]", s3, System.identityHashCode(s3));
