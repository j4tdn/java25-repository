...
public class Ex02Explain {
	...
	public static void main(String[] args) {
		/*
		 ...
		 - KDL String, biến value là private final --> giá trị của ô nhớ tại HEAP là hằng số(ko thay đổi)
		 ...
		 - Gán giá trị trực tiếp cho biến
		   ...
		   * Khi khởi tại giá trị --> kiểm tra xem giá trị mới đó đã xuất hiện trong constant pool chưa
		     . Nếu giá trị đó đã chứa trong 1 ô nhớ ở CONSTANT POOL -> ko khởi tạo ô nhớ mới, dùng ô nhớ cũ gán địa chỉ cho biến
